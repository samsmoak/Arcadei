	...
	return (
		<div>
			...
			>
				...
				<rect x='313' y='417.90372' width='262' height='16' fill='#00fbdb' />
				<rect x='313' y='533.90372' width='262' height='16' fill='#00fbdb' />
				<rect x='313' y='649.90372' width='262' height='16' fill='#00fbdb' />
				<circle cx='524' cy='388.80743' r='6' fill='#00fbdb' />
				<circle cx='545' cy='388.80743' r='6' fill='#00fbdb' />
				<circle cx='566' cy='388.80743' r='6' fill='#00fbdb' />
				<circle cx='524' cy='502.80743' r='6' fill='#00fbdb' />
				<circle cx='545' cy='502.80743' r='6' fill='#00fbdb' />
				<circle cx='566' cy='502.80743' r='6' fill='#00fbdb' />
				<circle cx='524' cy='616.80743' r='6' fill='#00fbdb' />
				<circle cx='545' cy='616.80743' r='6' fill='#00fbdb' />
				<circle cx='566' cy='616.80743' r='6' fill='#00fbdb' />
